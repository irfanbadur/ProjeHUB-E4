...
export const useProjectDocumentLayout = (scene) => {

const [documentDefs, setDocumentDefs] = useState(INITIAL_DEFS);
...
documentDefs.forEach((docDef) => {
  ...
  const headerParts = createDocumentHeaderParts(docDef.name, docContentJson.width, docContentJson.height);
